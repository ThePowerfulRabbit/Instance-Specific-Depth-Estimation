...
# YELLOW = [0, 255, 255] here only red channel is being changed
# RED = [0, 0, 255] here only green channel is being changed

B = np.zeros_like(depth_normalized)
G = np.zeros_like(depth_normalized) 
