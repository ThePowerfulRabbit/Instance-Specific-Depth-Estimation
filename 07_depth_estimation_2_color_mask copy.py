...
#lets make a colored gradient mask going from blue to red.
B = 255 - depth_normalized
G = np.zeros_like(depth_normalized) # we cannot just give a scalar 0 because other channels are arrays
R = depth_normalized
